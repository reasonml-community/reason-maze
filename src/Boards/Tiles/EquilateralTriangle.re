...
let adjacents_simple is_flipped => is_flipped ? [Left, Right, Up] : [Left, Right, Down];
...
let direction_to_border_simple is_flipped direction =>
  ...
  | Left => is_flipped ? Border.Line (bottomcenter, topleft) : Border.Line (topcenter, bottomleft)
  | Right =>
    is_flipped ? Border.Line (bottomcenter, topright) : Border.Line (topcenter, bottomright)
  };
