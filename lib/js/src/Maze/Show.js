...
function F(Board) {
  return (function (Gen) {
      ...
      var show = function (ctx, options, state) {
        ...
        if (match$2) {
          Belt_Array.forEach(Curry._1(Man[/* all_shapes */11], state), Curry._5(Presenter$1[/* draw_shape */6], ctx, /* tuple */[
                    xm,
                    ym
                  ], match$2[0], Curry._1(Man[/* current_age */9], state), Curry._1(Man[/* max_age */8], state)));
        }
      ...
      var show_debug = function (ctx, options, state) {
        ...
        var match$2 = options[/* draw_shapes */5];
        if (match$2) {
          Belt_Array.forEachWithIndex(Curry._1(Man[/* all_shapes */11], state), Curry._5(Presenter$1[/* draw_shapei */7], ctx, /* tuple */[
                    xm,
                    ym
                  ], match$2[0], Curry._1(Man[/* current_age */9], state), Curry._1(Man[/* max_age */8], state)));
        }
        ...
        if (match$3) {
          ...
          ctx.lineWidth = match$4[0];
          ctx.strokeStyle = match$4[1];
          Belt_List.forEach(Curry._1(Man[/* all_edges */10], state), Curry._2(Presenter$1[/* draw_edge */8], ctx, /* tuple */[
                    xm,
                    ym
                  ]));
        }
