...
function F(Board) {
  return (function (Gen) {
      ...
      var show_paint = function (ctx, param, state) {
        ...
        ctx.strokeStyle = "#aaa";
        return Belt_List.forEach(Curry._1(Man[/* paint_walls */21], state), Curry._2(Pres[/* draw_wall */0], ctx, /* tuple */[
                        xm,
                        ym
                      ]));
      };
    ...
    button.addEventListener('click', fn)
      ...
      var paint = function (options) {
        ...
        var paint_state = Curry._2(Man[/* paint_init */17], with_margins, options[/* size_hint */2]);
        ...
        Curry._2(listen_to_canvas, canvas, (function (param) {
                pstate[0] = Curry._2(Man[/* toggle_point */19], pstate[0], /* tuple */[
                      param[0] - xm,
                      param[1] - ym
                    ]);
        ...
        return Curry._2(make_button, "Go", (function () {
                      var match = Curry._1(Man[/* realize_state */20], pstate[0]);
                      if (match) {
