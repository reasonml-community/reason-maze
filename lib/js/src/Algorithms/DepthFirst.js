  ...
  var step = function (state) {
    ...
    if (active) {
      ...
      if (Caml_array.caml_array_get(visited, src[/* dest */1])) {
        ...
        var adjacents = Utils.shuffle(Caml_array.caml_array_get(state[/* adjacency_list */0], src[/* dest */1]));
        var edges = List.map((function (dest) {
                return /* record */[
                        /* src */src[/* dest */1],
                        /* dest */dest,
                        /* age */0
        ...
        var edges$1 = List.filter((function (x) {
        ...
        while(true) {
          ...
          if (edges$2) {
            ...
            var edge = edges$2[0];
            if (Caml_array.caml_array_get(visited, edge[/* dest */1])) {
              ...
              var current$1 = $$Array.append($$Array.of_list(others), current);
              return /* record */[
                      /* adjacency_list */state$1[/* adjacency_list */0],
                      /* visited */state$1[/* visited */1],
                      /* current */current$1,
            ...
            console.log(List.length(edges$2));
            return get_new(/* record */[
                        /* adjacency_list */state$1[/* adjacency_list */0],
                        /* visited */state$1[/* visited */1],
                        /* current */state$1[/* current */2],
