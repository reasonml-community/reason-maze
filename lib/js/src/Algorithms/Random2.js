      ...
      if (match$1.length !== 1) {
        ...
        if (Caml_array.caml_array_get(state[/* visited */0], dest) > 0) {
          ...
          var others = List.map((function(dest){
              ...
              }(dest)), List.filter((function(state){
                    return function (x) {
                      return +(Caml_array.caml_array_get(state[/* visited */0], x) === 0);
                    }
                    }(state)))(Curry._1(get_adjacent, dest)));
          var frontier = $$Array.append($$Array.of_list(others), state[/* frontier */2]);
          var state_000 = /* visited */state[/* visited */0];
          var state_001 = /* edges */Curry._2(Generator.PairSet[/* add */3], sortpair(match$2[0], dest), state[/* edges */1]);
