  ...
  newrecord[/* render */9] = (function () {
      ...
      return React.createElement("div", {
                  className: "settings"
                          ...
                          }), /* array */[])), "Canvas Size: ", String(settings[/* canvas_size */7]), ReasonReact.element(/* None */0, /* None */0, Range.make(300, 1000, settings[/* canvas_size */7], 10.0, 150, 20, /* false */0, (function (canvas_size) {
                            var newrecord = settings.slice();
                            return Curry._1(update, (newrecord[/* canvas_size */7] = canvas_size, newrecord));
                          }), /* array */[])), "Size: ", String(settings[/* size_hint */6]), ReasonReact.element(/* None */0, /* None */0, Range.make(3, 50, settings[/* size_hint */6], 1.0, 150, 20, /* false */0, (function (param) {
